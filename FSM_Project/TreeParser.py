...
def serializedATN():
    return [
        ...
        0, 11, 17, 6, 1, -1, 0, 12, 13, 3, 4, 2, 0, 13, 14, 6, 1, -
        1, 0, 14, 16, 1, 0, 0, 0, 15, 12,
        1, 0, 0, 0, 16, 19, 1, 0, 0, 0, 17, 15, 1, 0, 0, 0, 17, 18, 1, 0, 0, 0, 18, 3, 1, 0, 0, 0, 19,
        17, 1, 0, 0, 0, 20, 21, 5, 3, 0, 0, 21, 28, 6, 2, -
        1, 0, 22, 23, 5, 1, 0, 0, 23, 24, 3, 2,
        1, 0, 24, 25, 5, 2, 0, 0, 25, 26, 6, 2, -
        1, 0, 26, 28, 1, 0, 0, 0, 27, 20, 1, 0, 0, 0, 27,
...
class TreeParser (Parser):
    ...
    def tree_form(self):
        ...
        try:
            ...
            head = self.add_node(
                (None if localctx.a is None else localctx.a.text))
            self.state = 17
            ...
            while _la == TreeParser.T__0 or _la == TreeParser.WORD:
                ...
                self.connect(head, localctx.b.node_name)
                self.state = 19
                self._errHandler.sync(self)
                _la = self._input.LA(1)
    ...
    def subnode(self):
        ...
        try:
            ...
            if token in [TreeParser.WORD]:
                ...
                print ("1")
                node_name = self.add_node(
                    (None if localctx.b is None else localctx.b.text))
                pass
                ...
                self.match(TreeParser.T__1)
                print ("2")
                node_name = localctx._tree_form.head
                pass
            else:
